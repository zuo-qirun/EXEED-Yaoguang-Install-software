...
def chooseMode():
    global ModeChooser
    print("欢迎使用EXEED-Yaoguang-Install-software")
    print("本程序由Github zuo-qirun/B站 undefined_左提供技术支持, B站 187的王高高发布。使用请标明出处")
    print("本程序仅供学习和交流使用 遇到问题概不负责")
    print("若本程序出现问题，欢迎提交issues! 项目地址: https://github.com/zuo-qirun/EXEED-Yaoguang-Install-software/\n\n\n")
